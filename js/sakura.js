        ...
        return this.each(function () {
            ...
            if(par.is_Cherry) {
                setInterval(function () {
                    ...
                    margin_left = randomNum(5, 95);//位置最大值不能太大,要不然会越出屏幕，形成滚动条
                    time = randomNum(par.time_min, par.time_max);//花瓣持续时间调用随机数函数
                    image_size = randomNum(par.image_min, par.image_max);
                    $('#sakura:last-child').after('<img id="sakura" src="../img/pentagram.png" alt="">');
